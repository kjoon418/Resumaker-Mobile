            ...
            Column(modifier = Modifier.padding(20.dp)) {
                if (uploadedFile == null) {
                    ...
                    OutlinedButton(
                        ...
                        Text("건너뛰기", color = Color.Gray, fontSize = 16.sp)
                    }
                } else {
                    PrimaryButton(
        ...
        Column(
            ...
            Surface(
                ...
                Column(
                    ...
                    Text("PDF 파일 업로드", fontWeight = FontWeight.Bold, fontSize = 18.sp)
                    Spacer(modifier = Modifier.height(16.dp))
                    Button(
                    ...
                    Text("PDF, 최대 10MB", color = Color.LightGray, fontSize = 11.sp)
                }
            }
            if (uploadedFile != null) {
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            Text("2026.02 업로드", fontSize = 12.sp, color = Color.Gray)
                        }
                        if (isUploading) {
...
private fun ResumeUploadScreenPreview() {
    MaterialTheme {
        ResumeUploadScreen(onBackClick = { }, onSkip = { }, onNext = { })
    }
}
