...
val apiBaseUrl: String = localProperties.getProperty("api.base.url", "https://your-api-server.com/")

android {
    namespace = "com.resumaker.app"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.resumaker.app"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(project(":feature:career-manager"))
    implementation(project(":feature:resume-builder"))
