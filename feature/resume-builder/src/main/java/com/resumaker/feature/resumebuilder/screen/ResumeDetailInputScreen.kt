...
import com.resumaker.feature.resumebuilder.component.appbar.ResumeDetailInputTopBar
import com.resumaker.core.ui.button.PrimaryButton
import com.resumaker.feature.resumebuilder.component.dialog.AddExtraInfoDialog
import com.resumaker.feature.resumebuilder.component.dialog.AddProjectDialog
import com.resumaker.feature.resumebuilder.component.progress.StepProgressBar
import com.resumaker.feature.resumebuilder.component.section.CollaborationStyleSection
import com.resumaker.feature.resumebuilder.component.section.ExtraInfoSection
import com.resumaker.feature.resumebuilder.component.section.FutureGoalsSection
import com.resumaker.feature.resumebuilder.component.section.InfoBanner
import com.resumaker.feature.resumebuilder.component.section.ProjectHistorySection
import com.resumaker.feature.resumebuilder.component.section.ResumeFormatSection
import com.resumaker.feature.resumebuilder.component.section.SloganSection
import com.resumaker.feature.resumebuilder.component.section.StrengthKeywordsSection
import com.resumaker.feature.resumebuilder.component.section.TargetRoleSection
import com.resumaker.feature.resumebuilder.component.section.TechStackSection
...
fun ResumeDetailInputScreen(
    ...
    Scaffold(
        topBar = { ResumeDetailInputTopBar(onBackClick = onBackClick) },
        bottomBar = {
        ...
        Column(
            ...
            StrengthKeywordsSection(
                strengthKeywords = state.strengthKeywords,
            ...
            ProjectHistorySection(
                projectHistoryItems = state.projectHistoryItems,
...
private fun ResumeDetailInputScreenPreview() {
    MaterialTheme {
        ResumeDetailInputScreen(onBackClick = { }, onNext = { })
    }
}
