package com.resumaker.core.ui.bottombar
...
sealed class NavItem(
    ...
    data object Resume : NavItem(NavRoute.AllResumes, Icons.Default.Description, "이력서")
    data object Persona : NavItem(NavRoute.AllPersonas, Icons.Default.Groups, "페르소나")
    data object MyPage : NavItem(NavRoute.MyPage, Icons.Default.Person, "마이페이지")
}
