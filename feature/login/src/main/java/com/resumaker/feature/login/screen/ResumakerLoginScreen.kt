package com.resumaker.feature.login.screen
...
import com.resumaker.feature.login.component.section.LoginHeader
    ...
    Column(
        ...
        Row(
            ...
            TextButton(
                ...
                contentPadding = androidx.compose.foundation.layout.PaddingValues(start = 4.dp)
            ) {
                Text(
                    "회원가입",
